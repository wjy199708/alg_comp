...
model = dict(
    ...
    ######################Fusion RC part#########################3
    bi_dire_fusion=dict(
        type="BiDirectionWeightFusion", img_channels=64, radar_channels=64
    ),
    middle_radar_aug=dict(
        type="SamplingFusion",
        low_feats_channels=64,
    ...
    dense_radar_aug=dict(
        type="DenseRadarAug",
        low_feats_channels=256,
        hight_feats_channels=128,
        ret_sampling_pos=False,
    ),
    distillation=dict(
