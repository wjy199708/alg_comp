...
loss_depth_weight = 3  # 3 10 20 50 100
downsample = 8
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        #     num_layers=1,
        #     return_intermediate=False,
        #     only_ret_bev_query=True,
        #     bev_query_decoder=True,
        #     bev_query_decoder_layers=[256, 256, 128],
        ...
        #         attn_cfgs=[
        #             dict(
        #                 type="MultiBEVCrossAttention",
        #                 embed_dims=_dim_ // 2,
        #                 radar_embed_dims=_dim_ // 4,
        #                 num_heads=4,
        #                 d_head=16,
        #                 dropout=0.1,
        #                 bias=True,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        dict(
                            ...
                            radar_num_points=4,
                            num_points=8,
                            dense_radar_dims_in=_dim_,
                            embed_dims=_dim_,
                            embed_dims_in=sum([_dim_, _dim_]),
    ...
    train_cfg=dict(
        ...
        ref_point_assigner=dict(
            type="RefPointAssginer",
            cls_cost=dict(type="FocalLossCost", weight=2.0),
