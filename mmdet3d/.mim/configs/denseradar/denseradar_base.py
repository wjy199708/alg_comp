...
model = dict(
    ...
    img_bev_encoder_backbone=dict(
        type="ResNetForBEVDet", numC_input=numC_Trans
    ),
    ...
    pts_bbox_head=dict(
        ...
        bev_query_encoder=dict(
            ...
            extra_bev_pos=dict(
                ...
                num_feats=_pos_dim_,
                row_num_embed=bev_h_ // downsample,
                col_num_embed=bev_w_ // downsample,
            ),
            num_layers=2,
...
train_pipeline = [
    ...
    dict(
        type="LoadMultiViewImageFromFiles_DenseRadar", data_config=data_config
    ),
