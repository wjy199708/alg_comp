...
model = dict(
    ...
    img_bev_encoder_backbone=dict(
        type="CustomResNet",
        numC_input=numC_Trans * (len(range(*multi_adj_frame_id_cfg)) + 1) + 224,
    ...
    ######################Fusion RC part#########################3
    bi_dire_fusion=dict(
        type="BiDirectionWeightFusion", img_channels=160, radar_channels=64
    ),
    # middle_radar_aug=dict(
    #     type="SamplingFusion",
    #     low_feats_channels=160,
    #     hight_feats_channels=64,
    #     ret_sampling_pos=False,
    ...
    rc_bev_fusion=dict(
        ...
        hight_feats_channels=224,
        ret_sampling_pos=False,
    ),
    distillation=dict(
        sparse_feats_distill=dict(
            img_bev_distill=dict(type="FeatureLoss_InnerClip"),
...
work_dir = "d3pd/bevdet3.0/r50-samplingfeats_radar"
