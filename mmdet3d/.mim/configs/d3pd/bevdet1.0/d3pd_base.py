...
model = dict(
    ...
    rc_bev_fusion=dict(
        ...
        bi_dir=dict(in_channels=512),
    ),
    distillation=dict(
        sampling_pos_distill=dict(type="SimpleL1"),
        sampling_distill=dict(
            type="FeatureLoss",
...
load_from = "/mnt/data/exps/DenseRadar/ckpts/centerpoint_01voxel_second_secfpn_circlenms_4x8_cyclic_20e_nus_20220810_030004-9061688e.pth"


work_dir = "d3pd/base-r50-samplingdistill_samplingpos"
