...
class BEVDet_V3(CenterPoint):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(BEVDet_V3, self).__init__(**kwargs)
    ...
    def simple_test(self, points, img_metas, img=None, rescale=False, **kwargs):
        ...
        print2file(
            f"Date:{datetime.datetime.now()}--run time:{run_time}",
            f"run-time",
            mode="a+",
        )
